...
class EntryCreate(BaseModel):
    ...
    work: Annotated[str, StringConstraints(min_length=1, strip_whitespace=True, max_length=256)]
    struggle: Annotated[str, StringConstraints(min_length=1, strip_whitespace=True, max_length=256)]
    intention: Annotated[
        str, StringConstraints(min_length=1, strip_whitespace=True, max_length=256)
    ]
...
class EntryUpdate(BaseModel):
    ...
    work: Annotated[
        str | None, StringConstraints(min_length=1, strip_whitespace=True, max_length=256)
    ] = None
    struggle: Annotated[
        str | None, StringConstraints(min_length=1, strip_whitespace=True, max_length=256)
    ] = None
